...
Функция ОтправитьSMS(НомераПолучателей, Текст, ИмяОтправителя, Логин, Пароль, СпособАвторизации = неопределено) Экспорт
	...
	Если СпособАвторизации = "ПоКлючу" Тогда
		...
		СтруктураПараметров.Вставить("to", СтрокаПолучателей);
		СтруктураПараметров.Вставить("from", ИмяОтправителя);
	...
	СтруктураПараметров.Вставить("ИмяМетода","SendSMS"); //Руслан 21.12.2021
